...
FRONT_STOP_DISTANCE_M = 0.85
FRONT_STOP_CRITICAL_DISTANCE_M = 0.35
FRONT_STOP_TARGET_SPEED_MPS = 0.08
OBSTACLE_APPROX_RADIUS_M = 0.42
OBSTACLE_HALF_EXTENTS_XY_M = (
    (0.14, 0.275),
    (0.175, 0.15),
    (0.175, 0.15),
)
...
def _configure_lidar_navigation(env_cfg, debug_vis: bool) -> None:
    ...
    env_cfg.rewards.feet_air_time.weight = 0.40
    ...
    env_cfg.rewards.front_lidar_stop = RewTerm(
        func=mdp.analytic_lidar_stop_reward,
        weight=3.0,
        params={
            "obstacle_cfgs": obstacle_cfgs,
            "max_distance": FRONT_DEPTH_LIDAR_MAX_DISTANCE_M,
            "stop_distance": FRONT_STOP_DISTANCE_M,
            "critical_distance": FRONT_STOP_CRITICAL_DISTANCE_M,
            "target_stop_speed": FRONT_STOP_TARGET_SPEED_MPS,
            "horizontal_fov_range": FRONT_DEPTH_LIDAR_FOV_DEG,
            "num_rays": FRONT_DEPTH_LIDAR_RAYS,
            "obstacle_radius": OBSTACLE_APPROX_RADIUS_M,
            "sensor_offset_xy": FRONT_DEPTH_LIDAR_OFFSET_XY_M,
    ...
    env_cfg.rewards.front_lidar_stop_velocity = RewTerm(
        func=mdp.analytic_lidar_stop_velocity_penalty,
        weight=-5.0,
        params={
            "obstacle_cfgs": obstacle_cfgs,
            "max_distance": FRONT_DEPTH_LIDAR_MAX_DISTANCE_M,
    ...
    env_cfg.rewards.obstacle_keepout = RewTerm(
        func=mdp.obstacle_keepout_penalty,
        weight=-6.0,
        params={
            "obstacle_cfgs": obstacle_cfgs,
            "obstacle_half_extents_xy": OBSTACLE_HALF_EXTENTS_XY_M,
            "keepout_distance": 0.30,
            "margin": 0.20,
        },
    )
    env_cfg.rewards.body_obstacle_keepout = RewTerm(
        func=mdp.body_obstacle_keepout_penalty,
        weight=-4.0,
        params={
            "body_cfg": SceneEntityCfg("robot", body_names="base|.*_hip|.*_thigh|.*_calf|.*_foot"),
            "obstacle_cfgs": obstacle_cfgs,
            "obstacle_half_extents_xy": OBSTACLE_HALF_EXTENTS_XY_M,
            "keepout_distance": 0.12,
            "margin": 0.18,
        },
    )
    ...
    env_cfg.rewards.foot_lateral_separation = RewTerm(
        func=mdp.foot_lateral_separation_penalty,
        weight=-4.0,
        params={
            "left_foot_cfg": SceneEntityCfg("robot", body_names=".*L_foot"),
            "right_foot_cfg": SceneEntityCfg("robot", body_names=".*R_foot"),
            "side_margin": 0.045,
            "min_lateral_separation": 0.13,
        },
    )
    env_cfg.rewards.foot_contact_balance = RewTerm(
        func=mdp.foot_contact_balance_penalty,
        weight=-1.25,
        params={
    ...
    env_cfg.terminations.foot_crossing = DoneTerm(
        func=mdp.foot_crossing_termination,
        params={
            "left_foot_cfg": SceneEntityCfg("robot", body_names=".*L_foot"),
            "right_foot_cfg": SceneEntityCfg("robot", body_names=".*R_foot"),
            "crossing_margin": 0.02,
            "min_episode_steps": 10,
        },
    )
    env_cfg.terminations.obstacle_keepout = DoneTerm(
        func=mdp.obstacle_keepout_termination,
        params={
            "obstacle_cfgs": obstacle_cfgs,
            "obstacle_half_extents_xy": OBSTACLE_HALF_EXTENTS_XY_M,
            "keepout_distance": 0.18,
            "min_episode_steps": 10,
        },
    )
    env_cfg.terminations.body_obstacle_keepout = DoneTerm(
        func=mdp.body_obstacle_keepout_termination,
        params={
            "body_cfg": SceneEntityCfg("robot", body_names="base|.*_hip|.*_thigh|.*_calf|.*_foot"),
            "obstacle_cfgs": obstacle_cfgs,
            "obstacle_half_extents_xy": OBSTACLE_HALF_EXTENTS_XY_M,
            "keepout_distance": 0.04,
            "min_episode_steps": 10,
        },
    )
